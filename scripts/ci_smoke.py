...
def main() -> None:
    run(
        [
            ...
            "scripts/plan_dataset_release.py",
            "scripts/strip_release_audio.py",
            "scripts/inventory_source_archive.py",
            ...
            "src/nuyl_sushi/data/media_release.py",
            "src/nuyl_sushi/data/archive_inventory.py",
            ...
            "src/nuyl_sushi/cli/plan_media_release.py",
            "src/nuyl_sushi/cli/strip_release_audio.py",
            "src/nuyl_sushi/cli/inventory_archive.py",
